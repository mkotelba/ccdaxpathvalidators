...
public class FunctionalAndCognitiveStatusValidator implements MultipleXPathNodeValidator {

	private static final Logger logger = Logger.getLogger(FunctionalAndCognitiveStatusValidator.class);
	...
	public List<XPathValidatorResult> validateNode(String expression, XPath xpath, Node node, int nodeIndex, Map<String, String> params) {
		...
		logger.debug("EXECUTED THE Functional and Cognitive Status Validator");
