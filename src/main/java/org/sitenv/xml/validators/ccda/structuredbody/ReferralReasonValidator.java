...
public class ReferralReasonValidator implements MultipleXPathNodeValidator {

	private static final Logger logger = Logger.getLogger(ReferralReasonValidator.class);
	...
	public List<XPathValidatorResult> validateNode(String expression, XPath xpath, Node node, int nodeIndex, Map<String, String> params) {
		...
		logger.debug("EXECUTED THE Referral Reason Validator");
