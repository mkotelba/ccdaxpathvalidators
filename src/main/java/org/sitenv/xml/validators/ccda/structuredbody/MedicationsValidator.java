...
public class MedicationsValidator implements MultipleXPathNodeValidator {

	private static final Logger logger = Logger.getLogger(MedicationsValidator.class);
	private static final String[] EXPRESSIONS = {
		"code",
		"entry/substanceAdministration/consumable/manufacturedProduct/manufacturedMaterial/code",
		"entry/substanceAdministration/entryRelationship/act/code"
	};
	
	// this should be used with the template 2.16.840.1.113883.10.20.22.2.1.1
	public List<XPathValidatorResult> validateNode(String expression, XPath xpath, Node node, int nodeIndex, Map<String, String> params) {
		...
		logger.debug("EXECUTED THE Medications Validator");
