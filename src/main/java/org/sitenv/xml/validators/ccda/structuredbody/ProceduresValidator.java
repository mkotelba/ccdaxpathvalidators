...
public class ProceduresValidator implements MultipleXPathNodeValidator {

	private static final Logger logger = Logger.getLogger(ProceduresValidator.class);
	private static final String[] EXPRESSIONS = {
		"code",
		"entry/procedure/code",
		"entry/procedure/performer/assignedEntity/code"
	};
	
	// this should be used with the template 2.16.840.1.113883.10.20.22.2.7.1
	public List<XPathValidatorResult> validateNode(String expression, XPath xpath, Node node, int nodeIndex) {
		...
		logger.fatal("EXECUTED THE Procedures Validator");
