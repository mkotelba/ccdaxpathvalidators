...
public class SocialHistoryValidator implements MultipleXPathNodeValidator {

	private static final Logger logger = Logger.getLogger(SocialHistoryValidator.class);
