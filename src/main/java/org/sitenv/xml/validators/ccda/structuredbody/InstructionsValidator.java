...
public class InstructionsValidator implements MultipleXPathNodeValidator {

	private static final Logger logger = Logger.getLogger(InstructionsValidator.class);
	
	// this should be used with the template 2.16.840.1.113883.10.20.22.2.45
	public List<XPathValidatorResult> validateNode(String expression, XPath xpath, Node node, int nodeIndex, Map<String, String> params) {
		...
		logger.debug("EXECUTED THE Instructions Validator");
